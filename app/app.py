...
# subtítulo
st.markdown("Este é um Data App desenvolvido no curso de Data Science da Slack Academy para exibir uma solução de Machine Learning para recursos humanos")

# imprime o conjunto de dados usado
st.dataframe(dataset.head())

# grupos de colaborador.
